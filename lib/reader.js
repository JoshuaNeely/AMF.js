...
(function() {
  ...
  Reader = (function() {
    ...
    Reader.prototype.readByte = function(len, alwaysReturnBuffer) {
      var read;
    ...
    Reader.prototype.readString = function() {
      ...
      const integerArray = this.readByte(len, true);
      return String.fromCharCode.apply(null, integerArray);
    };

    Reader.prototype.readAMFHeader = function() {
      const headerInteger = this.readInt29();
      const def = headerInteger & 1 !== 0;
      const handle = headerInteger >> 1;
      return {
        isDef: def,
        value: handle
      };
