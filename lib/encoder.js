(function() {
  ...
  AMFEncoder = (function(superClass) {
    ...
    AMFEncoder.prototype.writeObject = function(value, amfType) {
  ...
  AMF0.STRING.encode = function(value) {
    var str;
    str = new Buffer.from(value, "utf8");
  ...
  AMF0.OBJECT.encode = function(value) {
    ...
    keys = value.getSerializableFields ? value.getSerializableFields() : Object.keys(value);
  ...
  AMF3.INTEGER.encode = function(value) {
    ...
    if (value < 0x4000) {
      return this.write([(value >> 7 & 0x7f) | 0x80, value & 0x7f]);
    }
    if (value < 0x200000) {
      return this.write([(value >> 14 & 0x7f) | 0x80, (value >> 7 & 0x7f) | 0x80, value & 0x7f]);
    }
    return this.write([(value >> 22 & 0x7f) | 0x80, (value >> 14 & 0x7f) | 0x80, (value >> 7 & 0x7f) | 0x80, value & 0xff]);
  };
  ...
  AMF3.ARRAY.encode = function(value) {
    ...
    if (value instanceof Array) {
      ...
      return this.serialize("", AMF3);
    }
  };

  AMF3.OBJECT.encode = function(value) {
    var externalizable, header, key, keyCount;
